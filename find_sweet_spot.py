...
# We need to add the last threshold to align with the scores
...
print(f'The best balanced performance (highest F1-score) is achieved at a threshold of: {best_f1_threshold:.4f}')
