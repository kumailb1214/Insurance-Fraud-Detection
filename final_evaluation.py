...
print("--- Loading Model and Data for Final Evaluation ---")
...
# Using the optimal threshold of 0.70 we found for our champion model
...
print("\n--- Final Model Performance on Full Original Dataset ---")
...
# Also calculate AUC-ROC for completeness
